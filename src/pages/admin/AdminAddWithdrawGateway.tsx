...
import { ArrowLeft, Save, Wallet, Plus, Trash2 } from 'lucide-react';
    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          name: formData.name,
          type: 'withdraw',
          gateway_type: 'withdraw', // Set default value since we removed the field
          ...
          configuration: {
            ...
            instructions: 'Transfer will be made to the bank account details provided during binding'
          }
        });

      if (error) throw error;

      toast.success('Withdraw gateway created successfully');
      navigate('/admin/payment-gateways');
    } catch (error) {
      console.error('Error creating withdraw gateway:', error);
      toast.error('Failed to create withdraw gateway');
    } finally {
      setSaving(false);
    }
  };
    ...
    <AdminLayout>
      <div className="p-6 space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Add Withdraw Gateway</h1>
            <p className="text-gray-600">Configure a new payment gateway for withdrawals</p>
          </div>
        </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="e.g., Bank Transfer, PayPal, Digital Wallet"
                      required
                    />
                  </div>
                </CardContent>
            ...
            <div className="space-y-6">
                  ...
                  <div className="p-4 border rounded-lg bg-gray-50">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Withdrawal Gateway</p>
                      </div>
                    </div>
              ...
              <div className="space-y-3">
                <Button type="submit" className="w-full" disabled={saving}>
                  ...
                  {saving ? 'Creating...' : 'Create Withdraw Gateway'}
                </Button>
              </div>
            </div>
          </div>
...
export default AdminAddWithdrawGateway;
