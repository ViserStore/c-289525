  ...
  return (
    <AppLayout showHeader={false} showBottomNav={true}>
      <div className="flex flex-col min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50">
        {/* Compact Header */}
        <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-rose-500 p-3 pt-6">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center">
              <Link to="/commission" className="mr-2 p-1 rounded-full bg-white/20 backdrop-blur-sm hover:bg-white/30 transition-all">
          ...
          <div className="bg-white/20 backdrop-blur-md rounded-xl p-3 border border-white/30">
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                ...
                <p className="text-pink-200 text-sm font-semibold">+{formatCurrencyAmount(monthlyEarnings)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 p-3 space-y-3">
          {/* Compact Filter Tabs */}
          <div className="bg-white/90 backdrop-blur-sm rounded-xl p-2 shadow-lg border border-purple-100">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10 bg-white/90 backdrop-blur-sm border-purple-200 focus:border-purple-400 rounded-xl h-10"
            />
          </div>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-1.5">
                            ...
                            <span className="text-xs text-pink-600 bg-pink-100 px-1.5 py-0.5 rounded-full">
          ...
          {filteredCommissions.length > 10 && (
            <div className="mt-4 text-center">
              <Button variant="outline" className="bg-white/80 backdrop-blur-sm border-purple-200 hover:bg-purple-50 rounded-xl px-6 text-purple-700 font-medium text-sm h-9">
